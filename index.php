...
<html>
	...
	<body>
		<header>
			...
			<div>
				<em><b><h1>How Humans Have Really Made the World Into Man vs. Earth</h1></b></em>
			</div>
				
		</header>
		<div>
			<h2>In this article, the Pollution Awareness Group feels obligated to inform all readers, on the destructive topic of Plastic Pollution.</h2>
		</div>
		<div>
			<h3><b>
		...
		<div>
			<p>Ever since the 1960s and early 70s, our beloved Earth has been "poisoned" as one would say, 
		...
		<div>
			<p>Plastic Pollution is the most harmful thing on our planet right now, but why? To answer this question, one must look deeper
		...
		which means that BPA a compound that prevents organic hormones from securing on to each other. This chemocal compound also infects air, dust, 
		...
		<div>
			...
			<div><h3><em>
				This is a Link to a Website That Provides Some Ideas For Switches in Our Everyday Lifestyles, Regarding Plastic Pollution
